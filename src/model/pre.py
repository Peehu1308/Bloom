...
# --- File path ---
file_path = "client/public/temperature/TG_C3S-glob-agric_gfdl-esm2m_hist_dek_19810101-20101231_v1.1.nc"
...
# Variable to process
var_name = 'TG'  # daily mean temperature
data_var = ds[var_name]

# Convert time to datetime
data_var['time'] = pd.to_datetime(data_var['time'].values)

# --- Resample to annual mean (since temperature is continuous) ---
